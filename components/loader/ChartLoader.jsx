...
export default function ChartLoader({ className, type }) {
  if (type === "bar") {
    return (
      <div
        className={`relative mb-7 rounded-lg bg-background dark:bg-[#09090a] p-2 text-left ${className} `}
      >
    ...
    return (
      <div
        className={`relative mb-6 rounded-lg bg-background dark:bg-[#09090a] p-4 text-left ${className}`}
      >

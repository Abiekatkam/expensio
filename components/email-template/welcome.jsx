        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              Hi, I'm {applicationClientUrls.config.developerName}, the creator of {applicationClientUrls.config.appName}, an open-source
              chat application designed to enhance communication and
              collaboration. We are excited to have you on board.
            </Text>
            <Text className="text-black text-[14px] leading-[24px]">
